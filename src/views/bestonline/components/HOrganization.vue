        ...
        >
            <el-collapse-item name="1">
                ...
                <table class="organization-table">
                    ...
                    <tbody>
                    <tr v-for="(item,index) in dueOrganizationAssessmentCreateFormList" :key="index">
                ...
                <el-form  label-position="right" label-width="250px" class="organization-form">
                    <el-form-item
                        label="实际控制人社会风评："
                        prop="actualControllerSocialId"
                        :rules="{required: true,message: '请选择风评',trigger: 'change'}"
                    >
                        <el-select
                ...
                <el-form  label-position="right" label-width="250px" class="organization-form">
                    <el-form-item label="组织综合评分：">
                        <el-input v-model="organizationScore" :disabled="true"></el-input>
                    </el-form-item>
                    <el-form-item label="实际控制人综合评分：">
                        <el-input v-model="actualControllerScore" :disabled="true"></el-input>
                    </el-form-item>
                </el-form>
            ...
            <el-collapse-item name="2">
                ...
                <el-form label-position="right" label-width="150px">
                    ...
                    <el-form-item
                        label="底线和禁区："
                        :rules="{required: true ,message: '底线和禁区不能为空',trigger: 'blur'}"
                    ...
                    <el-form-item
                        label="个人风格和喜好："
                        :rules="{required: true ,message: '个人风格和喜好不能为空',trigger: 'blur'}"
            ...
            <el-collapse-item name="3">
                ...
                <el-form label-width="200px" class="organization-form">
                    ...
                    <el-form-item label="在职人员平均薪资：">
                        <el-input
                            placeholder="请输入在职人员平均薪资"
                            maxlength="25"
                            :disabled="isdisabled"
                ...
                <table class="organization-table">
                    ...
                    <tbody>
                    <tr v-for="(item,index) in dueOrganizationPostCreateFormList" :key="index">
                        <td>
                            <span class="red-span">*</span>
                            {{item.post}}
                        </td>
                ...
                <table class="organization-table">
                    ...
                    <tbody>
                    <tr v-for="(item,index) in dueOrganizationOrgAssessmentCreateFormList" :key="index">
                        <td>
                            <span class="red-span">*</span>
                            {{item.assessmentDimension}}
                        </td>
...
export default {
    ...
    data () {
        return {
            ...
            isdisabled: false,
            activeName: '1',
            reviewOptions: [{ value: '', label: '请选择' }, { value: 0, label: '优' }, { value: 1, label: '良' }, {
                value: 2,
                label: '差'
            }],
            controlOptions: [{ value: '', label: '请选择' }, { value: 0, label: '绝对掌控' }, {
                value: 1,
                label: '中等掌控'
            }, { value: 2, label: '一般掌控' }],
            stableOptions: [{ value: '', label: '请选择' }, { value: 0, label: '高' }, { value: 1, label: '中' }, {
                value: 2,
                label: '低'
            }],
    ...
    methods: {
        ...
        onAddperson () {
            ...
            this.dueOrganizationSeniorCreateFormList.push({
                name: '',
                personnelSituation: '',
                position: '',
                positionDuty: ''
            ...
            handler (val) {
                ...
                val.map((item, index) => {
                    if (this.peopleNumber) {
                        item.percentage = ((+item.proportion / this.peopleNumber) * 100).toFixed(2)
                    } else {
                        item.percentage = ''
                    }
                })
