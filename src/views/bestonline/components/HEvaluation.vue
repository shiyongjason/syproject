    ...
    <div class="jd-manage">
        ...
        <table>
            ...
            <tr v-for="item in generalConclusionList" :key="item.index">
                <td style="width: 150px">{{item.createUser | judgeTureOrFalse}}</td>
            ...
            <tr v-for="item in judgesConclusionList" :key="item.index">
                <td>{{item.createUser | judgeTureOrFalse}}</td>
        ...
        <table>
            ...
            <tr>
                ...
                <td style="width: 120px">{{dueItemRecommend.isCooperate}}</td>
                <td>{{dueItemRecommend.scale}}</td>
                <td style="width: 200px">{{dueItemRecommend.yearGrowthRate}}</td>
                <td style="width: 120px">{{dueItemRecommend.equityRatio}}</td>
                <td style="width: 200px">{{dueItemRecommend.netProfitRate}}</td>
            </tr>
            <tr>
                <td>占比</td>
