...
<el-collapse-item name="12">
    ...
    <div class="form-cont-row">
        <div class="form-cont-col">
            <el-form-item label="编制单位：">
                <el-input v-model="form.caseFlow.writer" placeholder="请输入编制单位"></el-input>
            </el-form-item>
        </div>
        <div class="form-cont-col">
            <el-form-item label="时间：">
                <el-date-picker v-model="form.caseFlow.recordTime" type="date" placeholder="选择日期">
                </el-date-picker>
            </el-form-item>
        </div>
        <div class="form-cont-col">
    ...
    <div class="table-flex table_left">
        ...
        <div class="table-row" v-for="(item, index) in form.caseFlow.contentList" :key="index">
            ...
            <template v-else>
                <div class="table-col">{{item.typeName}}</div>
                <div class="table-col">
                    <el-input v-model="item.endOrCurrent" placeholder="请输入内容" maxlength="25" @keyup.native="oninputDueAndCase(index, 'endOrCurrent', $event, 1)">
                        <template slot="suffix">万</template>
                    </el-input>
                </div>
                <div class="table-col">
                    <el-input v-model="item.beginOrPrior" placeholder="请输入内容" maxlength="25" @keyup.native="oninputDueAndCase(index, 'beginOrPrior', $event, 1)">
                        <template slot="suffix">万</template>
                    </el-input>
                </div>
            </template>
