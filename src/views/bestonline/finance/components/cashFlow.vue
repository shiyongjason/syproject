...
import NowYear from './caseFlow_table/nowYear.vue'
import LastYear from './caseFlow_table/lastYear.vue'
import LastLastYear from './caseFlow_table/lastLastYear.vue'
export default {
    data () {
        return {
            tabName: 'nowYear'
