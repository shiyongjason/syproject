                ...
                <tr v-for="(item,index) in form.assetsLiabilities.assetListB" :key="index">
                    ...
                    <template v-else>
                        ...
                        <td>
                            ...
                            <template v-else>
                                <el-form-item label-width="0" :prop="`assetsLiabilities.assetListB[${index}].endOrCurrent`" :rules="rules.endOrCurrentNORequired">
                                    <el-input v-model="item.endOrCurrent" placeholder="请输入内容" maxlength="25">
                                        <template slot="suffix">万</template>
                                    </el-input>
                                </el-form-item>
                        ...
                        <td>
                            ...
                            <template v-else>
                                <el-form-item label-width="0" :prop="`assetsLiabilities.assetListB[${index}].beginOrPrior`" :rules="rules.beginOrPriorNORequired">
                                    <el-input v-model="item.beginOrPrior" placeholder="请输入内容" maxlength="25">
                                        <template slot="suffix">万</template>
                                    </el-input>
                                </el-form-item>
                ...
                <tr v-for="(item,index) in form.assetsLiabilities.liabilitiesListB" :key="index">
                    ...
                    <template v-else>
                        ...
                        <td>
                            ...
                            <template v-else>
                                <el-form-item label-width="0" :prop="`assetsLiabilities.liabilitiesListB[${index}].endOrCurrent`" :rules="rules.endOrCurrentNORequired">
                                    <el-input v-model="item.endOrCurrent" placeholder="请输入内容" maxlength="25">
                                        <template slot="suffix">万</template>
                                    </el-input>
                                </el-form-item>
                        ...
                        <td>
                            ...
                            <template v-else>
                                <el-form-item label-width="0" :prop="`assetsLiabilities.liabilitiesListB[${index}].beginOrPrior`" :rules="rules.beginOrPriorNORequired">
                                    <el-input v-model="item.beginOrPrior" placeholder="请输入内容" maxlength="25">
                                        <template slot="suffix">万</template>
                                    </el-input>
                                </el-form-item>
