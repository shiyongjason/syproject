<template>
    <div class="yearTable">
        <table class="item-wrapper">
            ...
            <tbody v-if="form.dueFinanceProfit.contentListL">
                <tr v-for="(item,index) in form.dueFinanceProfit.contentListL" :key="index">
                    ...
                    <template v-else>
                        ...
                        <td>
                            <template v-if="index === 16">
                                <el-form-item label-width="0" :prop="`dueFinanceProfit.contentListL[${index}].endOrCurrent`" :rules="rules.endOrCurrent">
                        ...
                        <td>
                            <template v-if="index === 16">
                                <el-form-item label-width="0" :prop="`dueFinanceProfit.contentListL[${index}].beginOrPrior`" :rules="rules.beginOrPrior">
