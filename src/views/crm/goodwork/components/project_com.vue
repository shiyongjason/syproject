    ...
    <div class="drawer-wrap">
        <el-form :model="projectForm" :rules="rules" ref="ruleForm" class="project-form" :label-width="formLabelWidth">
            ...
            <el-form-item label="合作机会分析：" prop="cooperationAnalyse">
                <el-input type="textarea" :autosize="{ minRows: 2, maxRows: 4}" placeholder="请输入合作机会分析" v-model="projectForm.cooperationAnalyse" maxlength="500">
                </el-input>
            </el-form-item>
...
export default {
    ...
    methods: {
        ...
        onSaveproject () {
            ...
            // 传值给后台去除customerRoleArr字段，深拷贝下不影响customerRoleArr变量
