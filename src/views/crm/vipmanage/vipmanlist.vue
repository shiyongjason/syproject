...
export default {
    ...
    methods: {
        ...
        async  searchList () {
            this.queryParams.maxServiceFeeDiscount = this.maxServiceFeeDiscount ? (this.maxServiceFeeDiscount * 0.1).toFixed(1) : ''
            this.queryParams.minServiceFeeDiscount = this.minServiceFeeDiscount ? (this.minServiceFeeDiscount * 0.1).toFixed(1) : ''
