        ...
        <div class="page-body-cont">
            ...
            :isAction="true" :actionMinWidth=200 :isShowIndex='true'>
                ...
                <template slot="action" slot-scope="scope">
                    ...
                    <h-button table @click="onLookproject(scope.data.row)" v-if="(scope.data.row.documentStatus==1||scope.data.row.documentStatus==2||scope.data.row.documentStatus==3)&&hosAuthCheck(auths.CRM_CREDIT_LOOK)">查看资料</h-button>
                </template>
            </basicTable>
        </div>
