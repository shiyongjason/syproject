<template>
    <el-dialog :title="targetVal.admin ? '编辑管理员信息': '编辑员工信息'" :visible.sync="editEmployeeDialogVisible" width="500px" :before-close="()=>{$emit('update:editEmployeeDialogVisible', false)}" :close-on-click-modal=false>
