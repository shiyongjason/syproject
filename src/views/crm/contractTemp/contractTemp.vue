    ...
    methods: {
        ...
        onClickCur (val) {
            ...
            if (val == 1) {
                ...
                //     return
                // }
                _temp = `<span id='platform_sign'><img style='width:100px' src="https://hosjoy-oss-test.oss-cn-hangzhou.aliyuncs.com/images/20201127/ab01c967-3172-4407-aba0-fa60351c19ab.png"></span>`
            }
