<template>
    <div class="wrapper page-table">
        ...
        <el-table :data="tableData" border height="573" v-loading="loading" style="width: 100%">
            <el-table-column algin="center" prop="subsectionName" width="100" label="分部" v-if="selectTh.indexOf('分部')>-1">
            </el-table-column>
            <el-table-column prop="regionName" algin="center" label="所属大区" v-if="selectTh.indexOf('所属大区')>-1">
            ...
            <el-table-column label="整体" v-if="selectTh.indexOf('整体')>-1">
                ...
                <el-table-column prop="overallGap" width="150" label="缺口">
                    <template slot-scope="scope">
                        <span v-if="scope.row.overallGoal === null || scope.row.overallGoal === '-'">-</span>
            ...
            <el-table-column label="环比" v-if="selectTh.indexOf('环比')>-1">
                <el-table-column prop="ringRatioUpperMoon" width="150" label="上月">
                    <template slot-scope="scope">
            ...
            <el-table-column label="复合同比" v-if="selectTh.indexOf('复合同比')>-1">
                <el-table-column prop="compositePeriod" width="150" label="复合同期">
                    <template slot-scope="scope">
            ...
            <el-table-column label="可比同比" v-if="selectTh.indexOf('可比同比')>-1">
                <el-table-column prop="comparablePeriod" width="150" label="可比同期">
                    <template slot-scope="scope">
            ...
            <el-table-column label="存量" v-if="selectTh.indexOf('存量')>-1">
                <el-table-column prop="stockActual" width="150" label="实际">
                    <template slot-scope="scope">
                        <span v-if="scope.row.stockActual === null || scope.row.stockActual === '-'">-</span>
                        <span v-else>{{scope.row.stockActual | money}}</span>
                    </template>
                </el-table-column>
                <el-table-column prop="stockTarget" width="150" label="目标">
                    <template slot-scope="scope">
                        <span v-if="scope.row.stockTarget === null || scope.row.stockTarget === '-'">-</span>
                        <span v-else>{{scope.row.stockTarget | money}}</span>
                    </template>
                </el-table-column>
                <el-table-column prop="stockAchievementRate" width="100" label="达成率">
                    <template slot-scope="scope">
            ...
            <el-table-column label="增量" v-if="selectTh.indexOf('增量')>-1">
                ...
                <el-table-column prop="incrementProportion" width="100" label="销售占比">
                    <template slot-scope="scope">
            ...
            <el-table-column label="年度累计" v-if="selectTh.indexOf('年度累计')>-1">
                <el-table-column prop="annualAccumulation" width="150" label="实际">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="annualTarget" width="150" label="目标">
                    <template slot-scope="scope">
                        <span v-if="scope.row.annualTarget === null || scope.row.annualTarget === '-'">-</span>
                        <span v-else>{{scope.row.annualTarget | money}}</span>
                    </template>
                </el-table-column>
                <el-table-column prop="annualAchievingRate" width="100" label="达成率">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="annualCumulativeGap" width="150" label="缺口">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="annualStockReached" width="150" label="存量达成">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="annualStockTarget" width="150" label="存量目标">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="annualStockCompletionRate" width="100" label="存量达成率">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="annualIncrementalAchievement" width="150" label="增量达成">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="annualIncrementalGoal" width="150" label="增量目标">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="annualIncrementalAchievementRate" width="100" label="增量达成率">
                    <template slot-scope="scope">
