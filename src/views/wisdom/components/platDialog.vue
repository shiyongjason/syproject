<template>
    <el-dialog title="变更记录" :visible.sync="visible" @close="$emit('update:show', false)" :show="show" width="40%" center>

        <el-button type="primary" @click="exportSignTable()">导出
        </el-button>

        <div class="page-table top10">
            <el-table :data="tableData" style="width: 100%" border>
                <el-table-column prop="date" label="变更因素" width="180">
                ...
                <el-table-column prop="changeSignScale" label="变更规模(万)" width="180">
                </el-table-column>
                <el-table-column prop="newSignScale" label="变更后规模(万)">
                </el-table-column>
