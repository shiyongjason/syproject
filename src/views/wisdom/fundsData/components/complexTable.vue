...
<script>
    ...
    export default {
                ...
                Exposure: [
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            {prop: 'loan_registrant', label: '登记人', sort: 10, width: '150'}
                        ]
                    },
                    {
                        label: '敞口还款账目总计',
        ...
        methods: {
            totalColumnTotalDo(tableDataTotal) {
                this.TotalColumn.forEach((value, index) => {
                    if (index > 2) {
                        value.children.forEach((val) => {
                            if (tableDataTotal[val.prop] !== null && tableDataTotal[val.prop] !== undefined) {
                                val.children[0].label = String(tableDataTotal[val.prop])
                            } else {
