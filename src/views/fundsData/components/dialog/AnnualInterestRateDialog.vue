<template>
    <el-dialog :title="title" :visible.sync="dialogVisible" :close-on-click-modal='false' width="1200px" :before-close='onCancle' center custom-class='diyclass'>
        <div class="form">
            <el-form :model="form" :rules="rules" ref="ruleForm" label-width="165px" class="demo-ruleForm">
                ...
                <div class="query-cont-row">
                    <div class="query-cont-col">
                        <el-form-item label="是否存在宽限期：" prop="name">
                            ...
                            <el-input v-model.trim="form.x" placeholder="请输入借款期限"></el-input>
                            <span class="dw">%</span>
                ...
                <div class="smalltitle">
                    ...
                    <span class="query-cont-col" style="margin-left:162px">
                        <el-button type="primary" size="small" @click="onSubmit">删除</el-button>
                    </span>
                </div>
                <div class="query-cont-row">
                    <div class="query-cont-col">
