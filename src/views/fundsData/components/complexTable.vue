<template>
    <div class="page-body">
        <div class="page-table">
            <hosJoyTable v-if="changeTable" ref="hosjoyTable" align="center" border stripe showPagination
                :column="column" :data="tableData" :total="pagination.total" :pageNumber.sync="pagination.pageNumber"
                :pageSize.sync="pagination.pageSize" @pagination="getList">
            </hosJoyTable>
        </div>
        <!-- 台账编号Dialog -->
        <misDialog :detailData='accountData' v-if='accountData' :dialogVisible='misDialogVisible'
            @onClose="misDialogVisible=false" />
        <!-- 供货商Dialog -->
        <supplierDialog :detailData='rowData' v-if='rowData' :dialogVisible='supplierDialogVisible'
            @onClose="supplierDialogVisible=false" />
        <!-- 还款方式Dialog -流贷 -->
        <AnnualInterestRateDialog :detailData='rowData' v-if='rowData' :dialogVisible='AnnualInterestRateDialogVisible'
            @onClose="AnnualInterestRateDialogVisible=false" />
        <!-- 开票日期Dialog -敞口 -->
        <billingDialog :detailData='rowData' v-if='rowData' :dialogVisible='billingDialogVisible'
            @onClose="billingDialogVisible=false" />
        <!-- 还款方式Dialog -->
        <repaymentDialog :detailData='rowData' v-if='rowData' :dialogVisible='repaymentDialogVisible'
            @onClose="repaymentDialogVisible=false" />
        <!-- 开票日期Dialog-分授信Credit -->
        <pointsCreditBillingDialog :detailData='rowData' v-if='rowData'
            :dialogVisible='pointsCreditBillingDialogVisible' @onClose="pointsCreditBillingDialogVisible=false" />
        <!-- 资金档案编号 -->
        <fileInfoDialog :detailData='rowData' v-if='rowData' :dialogVisible='fileinfoDialogVisible'
            @onClose="fileinfoDialogVisible=false" />
        <!-- 备注 -->
        <remarkDialog :detailData='rowData' v-if='rowData' :dialogVisible='remarkDialogVisible'
            @onClose="remarkDialogVisible=false" />
    </div>
</template>
