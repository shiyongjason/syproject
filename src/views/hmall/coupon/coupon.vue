                ...
                <div class="page-wrap flex-wrap-col">
                    <div class="flex-wrap-row">
                        <div class="flex-wrap-box">
                            <div class="flex-wrap-title">优惠券名称：</div>
                        ...
                        <div class="flex-wrap-box">
                            <div class="flex-wrap-title">优惠券状态：</div>
                            <div class="flex-wrap-cont">
                        ...
                        <div class="flex-wrap-box">
                            <div class="flex-wrap-title">优惠券类型：</div>
                            <div class="flex-wrap-cont">
...
import { findCouponList } from './api/index'
export default {
    name: 'coupon',
    components: {
        couponTable
    ...
    methods: {
        ...
        async findCouponList () {
            ...
            const { data } = await findCouponList(params)
