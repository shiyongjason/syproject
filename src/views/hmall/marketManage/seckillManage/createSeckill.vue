        ...
        return {
            ...
            column: [
                ...
                },
                {
                    ...
                    render: (h, scope) => {
                        return (
                            <el-form-item prop={`spikeSku[${scope.$index}].inventoryRemainNum`} label={scope.row.cityName} rules={this.inventoryRemainNumRules(scope.row, scope.$index)} label-width="10px" style="margin-top: 20px">
