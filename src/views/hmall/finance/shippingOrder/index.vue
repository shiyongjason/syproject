        ...
        <div class="page-body-cont">
            ...
            <basicTable :tableData="tableData" :tableLabel="tableLabel" :pagination="paginationInfo" @onCurrentChange="onCurrentChange" @onSizeChange="onSizeChange" :actionMinWidth="230" :isAction="true">
                ...
                <template slot="action" slot-scope="scope">
                    ...
                    <h-button table @click="onSynchronous(scope.data.row)" v-if="scope.data.row.status>10&&scope.data.row.status<60&&scope.data.row.ncSyncStatus!=40&&scope.data.row.ncSyncStatus!=50">同步</h-button>
