    ...
    computed: {
        ...
        tableLabel () {
            return [
                ...
                { label: '商品单价（元）', prop: 'price', sortable: true, formatters: 'money' },
                { label: '商品名称', prop: 'productName' },
                { label: '商品数量', prop: 'quantity' },
                { label: '折扣金额（元）', prop: 'discountAmount', formatters: 'money' },
                { label: '返利金额（元）', prop: 'rebateAmount', formatters: 'money' },
                { label: '佣金金额（元）', prop: 'commissionAmount', formatters: 'money' },
