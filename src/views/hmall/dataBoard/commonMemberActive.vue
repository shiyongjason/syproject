    ...
    <div class="page-body B2b">
        <div class="page-body-cont">
            <div class="query-cont__row">
                ...
                <div class="query-cont__col">
                    <div class="query-col__lable">进入时间：</div>
                    <div class="query-col__input">
                ...
                <div class="query-cont__col">
                    <div class="query-col__lable">离开时间：</div>
                    <div class="query-col__input">
...
export default {
    ...
    computed: {
        ...
        ...mapState('dataBoard', {
            commonMemberData: 'commonMemberData'
        }),
        pickerOptionsStart () {
            return {
                disabledDate: (time) => {
    ...
    methods: {
        ...
        onExport () {
            if (this.tableData.length <= 0) {
                ...
                window.location = interfaceUrl + 'ets/api/b2b/bi/member/spu/page/export? merchantName = ' + this.queryParams.merchantName +
        ...
        ...mapActions('dataBoard', [
            'findCommonMemberData'
        ]),
        async getCommonMemberData () {
            await this.findCommonMemberData(this.queryParams)
            this.tableData = this.commonMemberData.records
            this.paginationData = {
                pageNumber: this.commonMemberData.current,
                pageSize: this.commonMemberData.size,
                total: this.commonMemberData.total
            }
        }
    },
    mounted () {
