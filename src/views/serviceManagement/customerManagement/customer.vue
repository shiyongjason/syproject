<template>
    <div class="customerManagement page-body">
        ...
        <add-or-updata ref="addOrUpdata" :visible.sync="dialogCustomerEdit" :isShowDetail='showDetail' v-model="editInfo" @getList='getData' :role='role' :channelType='channelType'/>
    </div>
</template>
