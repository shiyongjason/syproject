<template>
    <div class="page-body">
        ...
        <OrderMessageTable :tableData="tableData" :paginationData="paginationData" @updateStatus="search" @onSizeChange="onSizeChange" @onCurrentChange="onCurrentChange">
        </OrderMessageTable>
    </div>
</template>

<script>
import OrderMessageTable from './components/orderMessageTable'
import { findReservations } from './api/index'
import { mapState } from 'vuex'
export default {
    name: 'orderMessageTable',
    components: {
        OrderMessageTable
    },
    data () {
